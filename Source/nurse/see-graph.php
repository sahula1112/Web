...
<html lang="en">
  ...
  <body>
    ...
    <section>
      ...
      <div class="container">
        <div class="well cover-seegraph">
          <p class="font-size-50 text-center font-bold margin-top-50">See graph</p>
        <div class="row margin-top-100">
          
          <div class="col-md-4 text-center">
             <a href="graph3.php"><button type="button" class="btn btn-primary navbar-btn btn-lg font-size-35">Weight</button></a>
          </div>
          <div class="col-md-4 text-center">
            <a href="graph3.php"><button type="button" class="btn btn-primary navbar-btn btn-lg font-size-35">Blood pressure</button></a>
          </div>
          <div class="col-md-4 text-center">
            <a href="graph3.php"><button type="button" class="btn btn-primary navbar-btn btn-lg font-size-35">Dose of Lasix</button></a>
          </div>
        </div>
        </div>
      </div>
