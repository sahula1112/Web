      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 col-md-push-4">
            <div class="panel panel-danger margin-top-100">
                <div class="panel-heading"> REGISTRE FAIL. PLEASE TRY AGAIN.</div>
                <div class="panel-body text-center margin-top-20">
                <a href="register.php"><button type="button" class="btn btn-danger btn-lg"> Go back to REGISTER PAGE </button></a>
                </div>
            </div>
          </div>
        </div>
